...
export function MessageBubble({
  ...
  return (
    <div
      className={`flex w-full ${isReceived ? "justify-start" : "justify-end"} ${animate ? "animate-message-in" : ""}`}
    >
      <div className="relative max-w-[75%]">
        <div
          className={`relative px-[12px] py-[8px] text-[16px] leading-[22px] rounded-[18px] ${
            isReceived
